...
@Validated // validasi untuk @PathVariable di tingkat class
@AllArgsConstructor
@RestController
...
public class PublisherResource {
	...
	public ResponseEntity<Void> updatePublisher(
			@PathVariable @Size(min = 36, max = 36, message = "publisher.id.not.uuid") String publisherId, // validasi ini harus disertakan anotasi @Validated pada tingkat class-nya
			@RequestBody @Valid PublisherUpdateRequestDTO dto // validasi untuk payload dengan @Valid
	) {
